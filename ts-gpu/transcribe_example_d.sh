    ...
    for ext in "${audio_extensions[@]}"; do
        ...
        for audio_file in "$incoming_dir"*."$ext"; do
            ...
            if [ "$sub_dir" == "diarize" ]; then
                ...
                python3 diarize_parallel.py --batch-size 16 -a "$audio_file"
                ...
                whisperx --batch_size 16 --model large-v3 --language en --output_dir "$new_dir" > "$new_dir/$base_name.txt" "$audio_file"
